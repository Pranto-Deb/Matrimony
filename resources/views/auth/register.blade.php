        ...
        <div class="card-body register-card-body">
            <p class="login-box-msg">Register a new membership</p>
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" placeholder="Phone No" name="phone_no" :value="old('phone_no')" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input mb-3">
                        <textarea id="address" class="form-control" name="address" :value="old('address')" placeholder="Address" rows="3"></textarea>
                    </div>
                    <div class="input-group mb-3">
